...
Public Function GetSharePointUrl(localPath As String) As String
    ...
    If DEBUG_MODE Then Debug.Print "[SharePointHelper] Looking for match: " & localPath
    ...
    If IsEmpty(arrSubKeys) Then
        If DEBUG_MODE Then Debug.Print "[SharePointHelper] No OneDrive providers found in registry"
        GetSharePointUrl = ""
        Exit Function
    End If
    ...
    For Each subKey In arrSubKeys
        ...
        If Len(mountPoint) > 0 Then
            If DEBUG_MODE Then Debug.Print "[SharePointHelper] Checking " & subKey & " MountPoint: " & mountPoint
            ...
            If InStr(1, localPath, mountPoint, vbTextCompare) = 1 Then
                ...
                If DEBUG_MODE Then Debug.Print "[SharePointHelper] MATCH! URLNamespace: " & urlNamespace
                ...
                If DEBUG_MODE Then Debug.Print "[SharePointHelper] SharePoint URL: " & sharePointUrl & "?web=1"
                Exit Function
            End If
        End If
    Next subKey

    If DEBUG_MODE Then Debug.Print "[SharePointHelper] No matching OneDrive provider found for path"
    GetSharePointUrl = ""
    Exit Function

ErrorHandler:
    If DEBUG_MODE Then Debug.Print "[SharePointHelper] Error: " & Err.Description
    GetSharePointUrl = ""
End Function
